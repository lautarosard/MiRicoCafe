...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250528170334_EliminacionFactuProduP3")]
    partial class EliminacionFactuProduP3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Factura", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Cobranza", "Cobranza")
                        .WithOne("Factura")
                        .HasForeignKey("Domain.Entities.Factura", "IdCobranza")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.NotaDeCredito", b =>
                {
                    b.HasOne("Domain.Entities.Factura", "Factura")
                        ...
                        .HasForeignKey("Domain.Entities.NotaDeCredito", "IdFactura")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.NotaDeDebito", b =>
                {
                    b.HasOne("Domain.Entities.Factura", "Factura")
                        .WithOne("NotaDebito")
                        .HasForeignKey("Domain.Entities.NotaDeDebito", "IdFactura")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
